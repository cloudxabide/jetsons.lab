...
### DeviceQuery Docker
```
root@xavier:~# docker build -t xift/jetson_devicequery:r32.5.0 . -f Dockerfile.deviceQuery
root@xavier:~# docker run --rm --runtime nvidia xift/jetson_devicequery:r32.5.0
...
### DeviceQuery (Kube)
```
root@xavier:~# kubectl logs nvidia -n default
./deviceQuery Starting...
